...
Author URI: http://øsüm.com/
*/

/*  Copyright 2015  Arthur Cormack cormack.arthur@gmail.com
...
final class Bulk_Move {
    ...
    const BOX_TAG_BY_CATEGORY    = 'bm_move_tag_by_category';
    ...
    public function __clone() {
        ...
        _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'bulk-move' ), '1.3.1' );
    }
    ...
    private function setup_actions() {
        ...
        register_activation_hook( __FILE__, 'bulk_move_create_db' );
    }


	function bulk_move_create_db () {
	...
	function add_move_posts_settings_panel() {
		...
		$this->move_posts_screen->add_help_tab(
			array(
				...
				'id'       => 'about_tab',
				'content'  => '<p>' . __( 'This plugin allows you to move posts in bulk from selected categories to another category, or tags to categories, or tag by category', 'bulk-move' ) . '</p>',
				'callback' => false
			)
		);
		...
		$this->move_posts_screen->set_help_sidebar(
            ...
            '<p><a href = "http://øsüm.com/wordpress/bulk-move">' . __( 'Plugin Homepage/support', 'bulk-move' ) . '</a></p>' .
            '<p><a href = "http://øsüm.com/blog">' . __( "Plugin author's blog", 'bulk-move' ) . '</a></p>' .
            '<p><a href = "http://øsüm.com/wordpress/">' . __( "Other Plugin's by Author", 'bulk-move' ) . '</a></p>'
        );
    ...
    function add_move_posts_meta_boxes() {
        add_meta_box( self::BOX_CATEGORY, __( 'Move Category-->Category', 'bulk-move' ), 'Bulk_Move_Posts::render_move_category_box', $this->post_page, 'advanced' );
        add_meta_box( self::BOX_TAG, __( 'Move By Tag', 'bulk-move' ), 'Bulk_Move_Posts::render_move_tag_box', $this->post_page, 'advanced' );
        add_meta_box( self::BOX_CATEGORY_BY_TAG, __( 'Move Tag-->Category', 'bulk-move' ), 'Bulk_Move_Posts::render_move_category_by_tag_box', $this->post_page, 'advanced' );

        //add another function: bulk move/add tag by category - ACMOD
        add_meta_box( self::BOX_TAG_BY_CATEGORY, __( 'Move Category-->Tag', 'bulk-move' ), 'Bulk_Move_Posts::render_move_tag_by_category_box', $this->post_page, 'advanced' );
