...
require_once dirname( __FILE__ ) . '/vendor-scoped/mundschenk-at/check-wp-requirements/class-mundschenk-wp-requirements.php';
...
function media_credit_uninstall() {
	...
	if ( $requirements->check() ) {
		...
		require_once __DIR__ . '/vendor-scoped/autoload.php'; // phpcs:ignore PHPCompatibility.Keywords.NewKeywords.t_dirFound
