 ...
 * HTML <input> element.
 */
abstract class Input extends \Media_Credit\Vendor\Mundschenk\UI\Abstract_Control
{
    /**
     ...
     * }
     */
    protected function __construct(\Media_Credit\Vendor\Mundschenk\Data_Storage\Options $options, $options_key, $id, array $args)
    {
     ...
     */
    public static function create(\Media_Credit\Vendor\Mundschenk\Data_Storage\Options $options, $options_key, $id, array $args)
    {
