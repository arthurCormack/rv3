 ...
 */
abstract class Abstract_Control implements \Media_Credit\Vendor\Mundschenk\UI\Control
{
    /**
     ...
     */
    protected function __construct(\Media_Credit\Vendor\Mundschenk\Data_Storage\Options $options, $options_key, $id, $tab_id, $section, $default, $short = null, $label = null, $help_text = null, $inline_help = \false, array $attributes = [], array $outer_attributes = [], $settings_args = [], $sanitize_callback = null)
    {
     ...
     */
    public function add_grouped_control(\Media_Credit\Vendor\Mundschenk\UI\Control $control)
    {
     ...
     * @param Control $control Any control.
     */
    public function group_with(\Media_Credit\Vendor\Mundschenk\UI\Control $control)
    {
        // Prevent self-references.
        if ($this !== $control) {
